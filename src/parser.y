/*
 * parser.y  —  StudyLang grammar (Bison/LALR(1))
 *
 * Grammar (BNF):
 *   program        -> statement_list
 *   statement_list -> statement
 *                  |  statement_list CONNECTOR statement
 *   statement      -> simple_stmt
 *   simple_stmt    -> opt_modifier ACTION SUBJECT
 *                     opt_timed opt_timeref opt_day opt_priority
 *   opt_modifier   -> e | MODIFIER
 *   opt_timed      -> e | FOR NUMBER TIMEUNIT
 *   opt_timeref    -> e | PREP_TIME timeref_target
 *   opt_day        -> e | PREP_OTHER TIMEOF
 *   timeref_target -> EVENT | TIMEOF
 *   opt_priority   -> e | PRIORITY
 */
